...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    "nav.features": "התכונות",
    "nav.about": "מי אנחנו",
    "nav.faq": "שאלות נפוצות",
    "nav.download": "הורידו עכשיו",
    
    // Hero
    "hero.badge": "אפליקציית הסטיילינג המתקדמת בעולם",
    "hero.title1": "הארון שלך.",
    "hero.title2": "הסטייליסט שלנו.",
    "hero.description": "בזמן שאת עוד מתלבטת, FLAIR כבר יודעת מה תלבשי.",
    "hero.descriptionHighlight": "AI שמכיר את הארון שלך, את הגוף שלך, ואת הסטייל שלך.",
    "hero.downloadFree": "הורידו בחינם",
    ...
    // Reviews
    "reviews.1": "הפסקתי לקנות בגדים חדשים. גיליתי שהארון שלי שווה הון - פשוט לא ידעתי לשלב.",
    "reviews.1.author": "מיכל כ.",
    "reviews.2": "בעל שלי שאל אם שכרתי סטייליסטית. זה רק FLAIR.",
    "reviews.2.author": "דנה ר.",
    "reviews.3": "3 שניות בבוקר במקום 20 דקות של התלבטות. המתמטיקה פשוטה.",
    "reviews.3.author": "יעל מ.",
    "reviews.4": "המודל האישי הציל אותי מקניות כושלות. רואה מראש מה לא יתאים.",
    "reviews.4.author": "נועה ש.",
    
    // Features
    "features.subtitle": "טכנולוגיה שמבינה אופנה",
    "features.title": "שלושה כלים. אפס התלבטויות.",
    "features.closet.title": "הארון הדיגיטלי",
    "features.closet.description": "צלמי פעם אחת, השתמשי לנצח. ה-AI מזהה כל פריט, מסיר רקע, מתייג ומארגן. הארון שלך - דיגיטלי, מסודר, תמיד איתך.",
    "features.model.title": "המודל האישי",
    "features.model.description": "5 תמונות = מודל דיגיטלי שלך. רואה כל לוק על הגוף שלך לפני שלבשת. חדר מדידה וירטואלי, 24/7, בלי תור.",
    "features.ai.title": "סטייליסט AI",
    "features.ai.description": "כתבי ״פגישה חשובה״ או ״יום חופש בבית״ - ה-AI מבין. לוקים מהארון שלך, מותאמים למזג האוויר, לאירוע, למצב הרוח.",
    ...
    // How it works
    "how.subtitle": "פשוט עד כאב",
    "how.title": "מארון מבולגן ללוק מושלם",
    "how.step1.title": "צלמי את הארון",
    "how.step1.description": "תמונה אחת לכל פריט. ה-AI מזהה, מסיר רקע, מתייג ומארגן. פעם אחת ונגמר.",
    "how.step1.time": "15 דק",
    "how.step2.title": "בחרי את הפריטים",
    "how.step2.description": "בחרי בגדים מהארון או תני ל-AI לבחור בשבילך. ערבבי, התאימי, נסי שילובים חדשים.",
    "how.step2.time": "30 שניות",
    "how.step3.title": "קבלי לוק על המודל שלך",
    "how.step3.description": "ה-AI מרכיב לוק ומראה אותו עליך. לא מתאים? שני פריט בלחיצה. מושלם? שמרי וצאי.",
    "how.step3.time": "20 שניות",
    
    // About
    "about.subtitle": "הסיפור שלנו",
    "about.title": "יצרנו את מה שתמיד חלמנו שיהיה.",
    "about.p1": "כולנו מכירות את זה: ארון מלא בבגדים, אבל כלום לא מרגיש נכון. עוד בוקר של להוציא הכל החוצה, לנסות, להתייאש, ולחזור לאותה חולצה משעממת. קניות אונליין שמגיעות ומאכזבות. בגדים עם תווית שאף פעם לא הורדנו.",
    "about.p2": "אז החלטנו לעשות משהו אחר. לא עוד אפליקציה שדוחפת לך לקנות עוד ועוד. אלא כזו שעוזרת לך לראות מה כבר יש לך - ואיך להפוך את זה ללוקים שגורמים לך להרגיש מדהים.",
    "about.p3": "המשימה שלנו פשוטה:",
    "about.p3.highlight": " שתצאי מהבית כל יום עם חיוך, בידיעה שאת נראית בדיוק כמו שרצית.",
    
    // Target Audience
    "target.subtitle": "נשמע מוכר?",
    "target.title": "FLAIR נבנתה בשבילך אם...",
    "target.1.title": "את עסוקה",
    "target.1.desc": "20 דקות של התלבטות? אין לך את הזמן הזה.",
    "target.2.title": "את קונה יותר מדי",
    "target.2.desc": "כי את בטוחה שאין לך מה ללבוש. יש.",
    "target.3.title": "את מרגישה תקועה",
    "target.3.desc": "אותם 5 פריטים, שוב ושוב. הגיע הזמן לגיוון.",
    "target.4.title": "את רוצה סטייליסטית",
    "target.4.desc": "אבל 500 שקל לשעה זה לא בתקציב.",
    "target.5.title": "את אוהבת אופנה",
    "target.5.desc": "ורוצה להפיק מקסימום מכל פריט בארון.",
    
    // FAQ
    "faq.subtitle": "עוד שאלות?",
    "faq.title": "הנה התשובות",
    "faq.1.q": "מה בדיוק FLAIR עושה?",
    "faq.1.a": "בקצרה: את מצלמת את הבגדים שלך, יוצרת מודל דיגיטלי שלך, ומקבלת לוקים מותאמים אישית תוך שניות. בלי לקנות כלום חדש.",
    "faq.2.q": "כמה זמן לוקח להעלות את כל הארון?",
    "faq.2.a": "ארון ממוצע - כ-15 דקות. ולא חייבים בבת אחת. תתחילי עם הפריטים האהובים, תוסיפי עם הזמן. האפליקציה עובדת גם עם 10 פריטים.",
    "faq.3.q": "המודל באמת דומה לי?",
    "faq.3.a": "מאוד. 5 תמונות שלך מספיקות ל-AI ליצור מודל שמשקף את הגוף, הפרופורציות והגובה שלך. לא מושלם פיקסל-פיקסל, אבל מספיק כדי לראות איך לוק יראה עליך.",
    "faq.4.q": "מה עם הפרטיות שלי?",
    "faq.4.a": "התמונות שלך מוצפנות ומאוחסנות בצורה מאובטחת. אנחנו לא מוכרים מידע, לא משתפים עם צד שלישי, ולא משתמשים בתמונות שלך לשום דבר מלבד האפליקציה.",
    "faq.5.q": "ה-AI מבין עברית?",
    "faq.5.a": "לגמרי. כתבי ״משהו נוח לעבודה מהבית״ או ״לוק לדייט בערב״ - ה-AI יבין בדיוק מה את צריכה. עברית טבעית, בלי תרגומים.",
    "faq.6.q": "ומה עם Android?",
    "faq.6.a": "עובדים על זה. כרגע iOS בלבד. תשאירי מייל ונעדכן אותך ברגע שנשיק.",
    
    // CTA
    "cta.subtitle": "מוכנות לשינוי?",
    "cta.title": "מחר בבוקר תדעי בדיוק מה ללבוש.",
    "cta.description": "7 ימים בחינם. בלי כרטיס אשראי. בלי התחייבות. רק את, הארון שלך, והסטייליסט הכי חכם שיש.",
  ...
  en: {
    ...
    // Hero
    "hero.badge": "The World's Most Advanced Styling App",
    "hero.title1": "Your Closet.",
    "hero.title2": "Our Stylist.",
    "hero.description": "While you're still deciding, FLAIR already knows what you'll wear.",
    "hero.descriptionHighlight": "AI that knows your closet, your body, and your style.",
    ...
    // Reviews
    "reviews.1": "I stopped buying new clothes. I discovered my closet is worth a fortune - I just didn't know how to mix and match.",
    "reviews.1.author": "Michal K.",
    "reviews.2": "My husband asked if I hired a stylist. It's just FLAIR.",
    "reviews.2.author": "Dana R.",
    "reviews.3": "3 seconds in the morning instead of 20 minutes of indecision. Simple math.",
    "reviews.3.author": "Yael M.",
    "reviews.4": "The personal model saved me from failed shopping trips. I can see what won't fit in advance.",
    "reviews.4.author": "Noa S.",
    
    // Features
    "features.subtitle": "Technology That Understands Fashion",
    "features.title": "Three Tools. Zero Indecision.",
    "features.closet.title": "Digital Closet",
    "features.closet.description": "Snap once, use forever. AI identifies each item, removes background, tags and organizes. Your closet - digital, organized, always with you.",
    "features.model.title": "Personal Model",
    "features.model.description": "5 photos = your digital model. See every look on your body before wearing it. Virtual fitting room, 24/7, no queue.",
    "features.ai.title": "AI Stylist",
    "features.ai.description": "Type \"important meeting\" or \"lazy day at home\" - the AI understands. Looks from your closet, matched to weather, event, mood.",
    ...
    // How it works
    "how.subtitle": "Painfully Simple",
    "how.title": "From Messy Closet to Perfect Look",
    "how.step1.title": "Photograph Your Closet",
    "how.step1.description": "One photo per item. AI identifies, removes background, tags and organizes. Once and done.",
    "how.step1.time": "15 min",
    "how.step2.title": "Select Your Items",
    "how.step2.description": "Choose clothes from your closet or let AI choose for you. Mix, match, try new combinations.",
    "how.step2.time": "30 seconds",
    "how.step3.title": "Get a Look on Your Model",
    "how.step3.description": "AI creates a look and shows it on you. Doesn't fit? Change an item with a tap. Perfect? Save and go.",
    "how.step3.time": "20 seconds",
    
    // About
    "about.subtitle": "Our Story",
    "about.title": "We Created What We Always Dreamed Of.",
    ...
    "about.p3": "Our mission is simple:",
    ...
    "target.1.title": "You're Busy",
    "target.1.desc": "20 minutes of indecision? You don't have that kind of time.",
    "target.2.title": "You Shop Too Much",
    "target.2.desc": "Because you're sure you have nothing to wear. You do.",
    "target.3.title": "You Feel Stuck",
    "target.3.desc": "Same 5 items, over and over. Time for variety.",
    "target.4.title": "You Want a Stylist",
    "target.4.desc": "But $150 an hour isn't in the budget.",
    "target.5.title": "You Love Fashion",
    "target.5.desc": "And want to maximize every item in your closet.",
    
    // FAQ
    "faq.subtitle": "More Questions?",
    "faq.title": "Here Are The Answers",
    "faq.1.q": "What exactly does FLAIR do?",
    "faq.1.a": "In short: you photograph your clothes, create a digital model of yourself, and get personalized looks in seconds. Without buying anything new.",
    ...
    "faq.3.a": "Very much. 5 of your photos are enough for AI to create a model reflecting your body, proportions and height. Not pixel-perfect, but enough to see how a look will appear on you.",
    ...
    "faq.5.q": "Does the AI understand my language?",
    "faq.5.a": "Absolutely. Type \"something comfortable for work from home\" or \"look for a dinner date\" - the AI will understand exactly what you need. Natural language, no translations.",
    ...
    "cta.description": "7 days free. No credit card. No commitment. Just you, your closet, and the world's smartest AI stylist.",
...
const LanguageProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    document.body.style.fontFamily = isRTL 
      ? "'Assistant', -apple-system, BlinkMacSystemFont, sans-serif"
